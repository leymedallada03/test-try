...
(function() {
    ...
    class DataBroadcaster {
        ...
        handleMessage(data) {
            if (data.type === 'DATA_CHANGED' && BROADCAST_ALLOWED_ACTIONS.includes(data.action)) {
        ...
        broadcastChange(action, details = '', metadata = {}) {
            if (!BROADCAST_ALLOWED_ACTIONS.includes(action)) {
        ...
        logToServer(data) {
            ...
            fetch("https://script.google.com/macros/s/AKfycbytvSPndcz2Ou0Kz_XOUw6Ztlwx55ml2TsaEZFTdLYVCCVfOMwdRohgq_cOPPeluQMTCw/exec", {
                method: "POST",
                body: formData
            }).catch(() => { /* ignore errors */ });
        }
